...
function loop() {
  ...
  if (bodies[0].m_position.x <= -50) {
		bodies[0].SetCenterPosition(new b2Vec2(930, bodies[0].m_position.y), bodies[0].m_rotation);
	}
...
function mousePress() {
	if (isMouseDown) {
		var body = bodies[0];
		body.SetLinearVelocity(new b2Vec2(-150,-400));
	}
}
